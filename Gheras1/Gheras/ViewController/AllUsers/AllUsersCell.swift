...
class AllUsersCell : UITableViewCell {
  ...
  override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    let cellFont = UIFont(name: pointLabel.font.fontName, size: 13)
      pointLabel.font = cellFont
...
//RequstTypeConstraint
      ...
      pointLabel.topAnchor.constraint(equalTo: topAnchor ,constant: 10).isActive = true
      pointLabel.heightAnchor.constraint(equalToConstant: 30)
      pointLabel.trailingAnchor.constraint(equalTo: trailingAnchor , constant: -20 ).isActive = true
     
//RequstIDConstraint
      nameLabel.translatesAutoresizingMaskIntoConstraints = false
      nameLabel.topAnchor.constraint(equalTo: pointLabel.bottomAnchor , constant: 10).isActive = true
      nameLabel.heightAnchor.constraint(equalToConstant: 30)
      nameLabel.trailingAnchor.constraint(equalTo: trailingAnchor , constant: -20 ).isActive = true// constant will change
