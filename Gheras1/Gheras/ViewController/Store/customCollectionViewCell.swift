...
//        butt.layer.cornerRadius = butt.frame.height/2
    ...
    @objc func addToCart() {
        ...
        defaults.set(myLabel.text, forKey: "SavedName")
        defaults.set(priceLabel.text, forKey: "SavedPrice")
        let SavedName = defaults.string(forKey: "SavedName")
        let SavedPrice = defaults.string(forKey: "SavedPrice")
